...
/*
Package genpb is a reverse proxy.
...
func request_ServerInfoService_GetInfo_0(ctx context.Context, marshaler runtime.Marshaler, client ServerInfoServiceClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
...
func RegisterServerInfoServiceHandlerClient(ctx context.Context, mux *runtime.ServeMux, client ServerInfoServiceClient) error {
	...
	mux.Handle("GET", pattern_ServerInfoService_GetInfo_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := request_ServerInfoService_GetInfo_0(rctx, inboundMarshaler, client, req, pathParams)
		...
		forward_ServerInfoService_GetInfo_0(ctx, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)
...
var (
	pattern_ServerInfoService_GetInfo_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0}, []string{"info"}, ""))
)

var (
	forward_ServerInfoService_GetInfo_0 = runtime.ForwardResponseMessage
)
